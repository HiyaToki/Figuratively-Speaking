...
for problem in dataset.keys():
    ...
    for key in keys:
        ...
        x_train, y_train, x_test, y_test = get_x_y(dataset[problem], key)
        ...
        results[problem][key] = f1
        print("DONE!")
    print("")

output_file = base_dir + "/data/output/evaluations/pan18-scale-mlp-auth-attr-results.json"
