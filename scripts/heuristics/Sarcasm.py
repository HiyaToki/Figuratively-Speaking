...
def predict(text):
    ...
    with torch.no_grad():
        ...
        # result = 0 if prediction == "not_sarcasm" else 1

    return prediction

# method to predict sarcasm labels
...
model_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../models/roberta-large-sarcasm"))
